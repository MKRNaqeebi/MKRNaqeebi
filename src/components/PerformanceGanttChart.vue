  ...
  <div>
    <div class="m-3 py-3">
      <div class="flex ml--5">
        ...
        <button @click="fetchIssues(); loadTheTemplateAbove();"
          class="btn ml-8 rounded-lg w-24 border-0 h-12">Fetch</button>
      </div>
      <div>
        <div class="my-2.5">
...
export default {
  ...
  methods: {
    ...
    fetchIssues() {
      ...
      axios({
        method: "get",
        url: `https://api.github.com/repos/${this.valueRepo}/issues?state=open&assignee=${this.selectedAssignee}`,
        auth: {
